      ...
      {!activeFolder ? <section className={styles.folderGrid} aria-label="Project folders">
        ...
        <section className={styles.detailWindow} aria-label="MONEAR 상세 작업">
          ...
          <aside className={styles.detailDescription}>
            ...
            <p className={styles.detailCopy}>막연하게만 느껴지는 재무 계획, 어디서부터 시작하고 있나요? <br />MONEAR는 사회초년생의 재무 목표를 구체적인 <br />로드맵으로 설계하고, 이를 실천 가능한 금융 행동으로 <br />연결하는 서비스입니다. 현재의 수입과 지출, <br />목표와 상황을 바탕으로 나에게 필요한 방향을 찾고, <br />예상치 못한 변화에도 유연하게 계획을 조정하며 <br />원하는 미래에 한 걸음씩 가까워질 수 있도록 돕습니다. <br />작은 금융 행동으로 미래의 목표를 가까이, MONEAR.</p>
          </aside>
          <div
