...
const projects = {
  ...
  BRANDING: {
    ...
    category: "Branding",
    date: "2026.06",
    subtitle: "오피스의 리추얼을 만드는 블렌딩 티 브랜드",
    description: {
  ...
  INTERACTION: {
    ...
    subtitle: "",
    description: {
      body: "서로 다른 무게와 위치를 가진 두 요소는 별도의 인터랙션 없이도 순간적인 균형을 만든 뒤, 다시 기울고 반응하며 움직임을 이어간다. 사용자의 드래그가 개입하는 순간 각 요소는 고유한 운동값과 속도로 반응하며, 다시 예측할 수 없는 균형을 찾아간다.",
    },
    mobileBody: [
      "서로 다른 무게와 위치를 가진 두 요소는 별도의 인터랙션 없이도 순간적인 균형을",
      "만든 뒤, 다시 기울고 반응하며 움직임을 이어간다. 사용자의 드래그가 개입하는 순간 각 요소는 고유한 운동값과 속도로 반응하며, 다시 예측할 수 없는 균형을 찾아간다.",
    ],
    media: [
      {
        type: "iframe",
        src: "/dynamic_balance/index.html",
        title: "Counterweight interactive canvas",
      },
    ],
  },
  "EDITORIAL DESIGN": {
    ...
    date: "2026",
    subtitle: "자우림 2집 타이틀곡 「미안해 널 미워해」를 재해석한 뮤직북",
    description: {
